...
public interface Interface_SanPham {
    ...
    public final String GET_UPDATESP = "UPDATE SanPham SET tensanpham = ?, giasanpham = ?, motasanpham = ?, size = ?,ngaysanxuat = ?, soluong = ? WHERE masanpham = ?";
    ...
    public final String GET_ADDSP = "insert into sanpham(masanpham,tensanpham,giasanpham, motasanpham,size,ngaysanxuat,soluong ) values(?, ?, ?, ?, ?, ?, ?)";
    ...
    public final String GET_GIASP = "SELECT giasanpham from sanpham where motasanpham = ?";
